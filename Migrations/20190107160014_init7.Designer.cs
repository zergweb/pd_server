...
namespace PdApi.Migrations
{
    ...
    [Migration("20190107160014_init7")]
    partial class init7
    {
            ...
            modelBuilder.Entity("PdApi.Model.PublicProfileConfig", b =>
                {
                    ...
                    b.Property<bool>("ExtraInfo");

                    b.Property<bool>("FacucltySection");

                    b.Property<bool>("Faculty");
            ...
            modelBuilder.Entity("PdApi.Model.PublicProfileConfig", b =>
                {
                    b.HasOne("PdApi.Model.LkStudent", "Student")
                        .WithOne("Config")
                        .HasForeignKey("PdApi.Model.PublicProfileConfig", "LkStudentId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
